        ...
        <View style={{ borderBlockColor: Colors.White }}>
            <ScrollView>
                ...
                <View style={{ flexDirection: "row", marginLeft: 15, marginTop: 5 }}>
                    <TextComponent
                    size={34} weight={"700"} color={Colors.Darkgrey} width={280}>Profile</TextComponent>
                    <TouchableOpacity>
                ...
                <View style={{ flexDirection: "row", marginLeft: 25, marginTop: 15 }}>
                    ...
                    <View style={{ marginLeft: 20, marginTop: 7, width: 160 }}>
                        <View style={{ flexDirection: "row" }}>
                            <TextComponent
                            size={19} weight={"700"} color={Colors.Darkgrey}>Jone Doe</TextComponent>
                        ...
                        <TextComponent
                        size={12} weight={"400"} color={Colors.Grey}>145 Reviews</TextComponent>
                    </View>
                    <TouchableOpacity style={styles.plan}>
                        <TextComponent title={"Bronze plan"}
                        size={14} weight={"400"} color={Colors.White} styles_font={{alignSelf:"center"}}/>
                ...
                <View style={styles.view}>
                    <View style={{ marginLeft: 25 }}>
                        <TextComponent
                        size={20} weight={"400"} color={Colors.Darkgrey} styles_font={{alignSelf:"center"}}>320</TextComponent>
                        <TextComponent
                        size={16} weight={"400"} color={Colors.Grey}>Sessions</TextComponent>
                    </View>
                    <View style={{ marginLeft: 25 }}>
                        <TextComponent
                        size={20} weight={"400"} color={Colors.Darkgrey} styles_font={{alignSelf:"center"}}>12</TextComponent>
                        <TextComponent
                        size={16} weight={"400"} color={Colors.Grey}>Clients</TextComponent>
                    </View>
                    <TouchableOpacity style={styles.progress}>
                        <TextComponent
                        size={14} weight={"400"} color={Colors.White} styles_font={{alignSelf:"center"}}>My progress</TextComponent>
                    </TouchableOpacity>
                </View>
                <View style={{ flexDirection: "row", marginTop: 15, marginLeft: 15 }}>
                    ...
                    <TextComponent
                    size={12} weight={"400"} color={Colors.Grey}>ADVANCED</TextComponent>
                </View>
                ...
                <TouchableOpacity style={styles.box}>
                    <TextComponent
                    size={14} weight={"400"} color={Colors.Textgrey}>Notifications</TextComponent>
                ...
                <View style={styles.details}>
                    <TextComponent
                    size={14} weight={"400"} color={Colors.Grey} styles_font={{alignSelf:"center"}} width={100}>Email</TextComponent>
                    <TextComponent
                    size={14} weight={"400"} color={Colors.Darkgrey} styles_font={{alignSelf:"center"}} textAlign={"right"}>anna@gmail.com</TextComponent>
                </View>
                <View style={styles.details}>
                    <TextComponent
                    size={14} weight={"400"} color={Colors.Grey} styles_font={{alignSelf:"center"}}>Date of birth</TextComponent>
                    <TextComponent
                    size={14} weight={"400"} color={Colors.Darkgrey} styles_font={{alignSelf:"center"}}>10.03.1980</TextComponent>
                </View>
                <TextComponent
                size={16} weight={"400"} color={Colors.Darkgrey} styles_font={{marginTop: 15,
                    marginLeft: 30}}>About me</TextComponent>
                <View style={styles.line}>
<TextComponent
size={14} weight={"400"} color={Colors.Grey} styles_font={{marginLeft: 12,
    lineHeight: 20,}} width={310}>Mauris quis orci faucibus, egestas nibh sed vestibulum elit. Nam est dui, accumsan a lorem tincidunt, pellentesque pulvinar lorem. Mauris quis orci faucibus, egestas nibh sed vestibulum elit. Nam est dui, accumsan a lorem  tincidunt, pellentesque pulvinar lorem</TextComponent>
                ...
                <TextComponent
                size={16} weight={"600"} color={Colors.Darkgrey} styles_font={{marginTop: 15,
                ...
                <View style={styles.account}>
                    <View style={{ width: "75%" }}>
                        ...
                        <TextComponent
                        size={12} weight={"400"} color={Colors.Grey} styles_font={{marginLeft:29}}>**** **** ****</TextComponent>
                    </View>
                    <TouchableOpacity>
                ...
                <TouchableOpacity
                    ...
                    <TextComponent
                    size={18} weight={"400"} color={Colors.Grey} styles_font={{padding: 15,
                ...
                <View style={styles.session}>
                    <TextComponent
                    size={16} weight={"400"} color={Colors.Textgrey} styles_font={{marginLeft:15}}>My Session</TextComponent>
                    <TouchableOpacity>
                    ...
                    <TouchableOpacity onPress={()=>NavigationContainer.navigate('MySessions')}>
                        <TextComponent
                        size={14} weight={"400"} color={Colors.Blue} styles_font={{marginLeft: 190,
                ...
                <View style={styles.session}>
                    <TextComponent
                    size={14} weight={"400"} color={Colors.Textgrey}>MY PACKAGES</TextComponent>
                    <TouchableOpacity>
                        <TextComponent
                        size={14} weight={"400"} color={Colors.Blue} styles_font={{marginLeft: 190,
                            marginTop: 2}}>View All</TextComponent>
...
<TouchableOpacity>
<TextComponent
size={14} weight={"400"} color={Colors.Blue} styles_font={{marginTop:10,
    marginLeft:22}}>Booking cancellation policy</TextComponent>
</TouchableOpacity>
<TouchableOpacity>
    <TextComponent
    size={14} weight={"400"} color={Colors.Red} styles_font={{marginTop:20,
